...
BACKGROUND_LABELS = {"", "OK", "UNKNOWN", "INTERFERENCE", "UNCERTAIN", "IGNORE"}
...
class DatasetValidationResult:
    ...
    def summary(self) -> str:
        ...
        lines.append(f"OK: {self.ok_images}  NG: {self.ng_images}  Unlabeled: {self.unlabeled_images}")
...
def _is_ng_label(label: str) -> bool:
    ...
    if clean in {"OK", "UNKNOWN", "INTERFERENCE", "UNCERTAIN", "IGNORE"}:
        return False
    return True
...
def _is_ok_label(label: str) -> bool:
    ...
    clean = label.strip().upper()
    return clean in {"OK", "UNKNOWN", "INTERFERENCE", "UNCERTAIN", "IGNORE"} or clean == ""
